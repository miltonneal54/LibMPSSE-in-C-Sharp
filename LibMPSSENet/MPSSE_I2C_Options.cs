namespace MPSSENet
{
    public partial class MPSSE_I2C
    {
        ...
        public class ChannelConfig
        {
            ...
            /// <summary>
            /// Specifies the directions and values of the lines associated with the lower byte of 
            /// the MPSSE channel after I2C_InitChannel and I2C_CloseChannel functions are called.
            /// </summary>
            public uint Pin;
        }
        ...
        public class ConfigOptions
        {
            ...
            /// <summary>
            /// Bit 4 manages the Lower GPIO pins.
            /// </summary>
            /// <remarks>Available only in a FT232H device.</remarks>
            public const uint I2C_ENABLE_PIN_STATE_CONFIG = 0x00000010;

            // Bits 5 to 31 reserved.
        }
