...
namespace MPSSE_Test
{
    ...
    class I2CTestProgram
    {
        ...
        public const byte I2C_Slave = 0x56;
        public const byte DataOffset = 10;
        ...
        static void Main()
        {
            ...
            for (int x = 0; x < 10; x++)
            {
                mpsse_i2c.FT_WriteGPIO(0xff , 0x7f);
                System.Threading.Thread.Sleep(250);
                mpsse_i2c.FT_WriteGPIO(0xff, 0xff);
                System.Threading.Thread.Sleep(250);
            }
        ...
        static MPSSE.FT_STATUS WriteByte(byte deviceAddress, uint location, byte data)
        {
            ...
            byte slaveAddress = (byte)(deviceAddress | ((location >> 8) & 0x07));
            ...
            /* status = mpsse_i2c.I2C_DeviceWrite(slaveAddress, bytesToTransfer, buffer, ref bytesTransfered,
                                                MPSSE_I2C.TransferOptions.I2C_TRANSFER_OPTIONS_FAST_TRANSFER_BYTES);*/
